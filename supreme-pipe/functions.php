...
add_action( 'wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style( 'hello-elementor-theme-style' );

    // Child theme custom CSS (design tokens, utility overrides)
    wp_enqueue_style(
        'supreme-pipe-theme',
...
add_action( 'acf/init', function () {
    ...
    foreach ( [
        [ 'Homepage',     'supreme-homepage'   ],
        [ 'Global CTA',   'supreme-cta'        ],
        [ 'Company Info', 'supreme-company'    ],
        [ 'Footer',       'supreme-footer'     ],
        [ 'Quote Form',   'supreme-quote-form' ],
        [ 'SEO Defaults', 'supreme-seo'        ],
    ] as [ $title, $slug ] ) {
        acf_add_options_sub_page( [
            'page_title'  => $title,
            'menu_title'  => $title,
            'parent_slug' => 'supreme-settings',
            'menu_slug'   => $slug,
            'capability'  => 'manage_options',
        ] );
    }
